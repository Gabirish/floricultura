...
namespace FloriculturaBeta.Controllers
{
    ...
    public class ClientesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ClienteId,ClienteNome,ClienteCpf,ClienteTelefone,ClienteEstado,ClienteCidade,ClienteBairro,ClienteRua,ClienteNumero,ClienteComplemento")] Cliente cliente)
        {
            if (ModelState.IsValid)
            {
